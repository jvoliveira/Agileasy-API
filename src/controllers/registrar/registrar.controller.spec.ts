...
describe('RegistrarController', () => {
  ...
  it('should be resolved registrar/parceiro', async ()  => {
    ...
    await expect(controller.registerParceiro({email: "vimivini99@gmail.com", senha: "123456",nomePublico: 'V1pi', usuario:{nome: "Vinicius"}} as any)).resolves.toStrictEqual(shouldReturn)
    ...
    expect(mockPrestadorService.create).toBeCalledWith({email: "vimivini99@gmail.com", senha: "123456",nomePublico: 'V1pi', usuario:{nome: "Vinicius", token: "uid-valido",}})
  });
  ...
  it('should be throws registrar/parceiro', async ()  => {
    ...
    await expect(controller.registerParceiro({email: "vimivini99@gmail.com", senha: "123456",nomePublico: 'V1pi', usuario:{nome: "Vinicius"}} as any)).rejects.toStrictEqual(shouldReturn)
    expect(mockFirebaseUser.createUser).toBeCalledWith({
      email: 'vimivini99@gmail.com',
      password: '123456',
      displayName: 'V1pi',
    ...
    expect(mockPrestadorService.create).toBeCalledWith({email: "vimivini99@gmail.com", senha: "123456",nomePublico: 'V1pi', usuario:{token: "uid-valido",nome: "Vinicius"}})
  });
